...
<form class="box" action="" method="post">
			...
			<input type="text" class="box-input" name="naissance" placeholder="Date de naissance" required />
    		<input type="text" class="box-input" name="categorie" placeholder="categorie" />
   			<input type="text" class="box-input" name="deces" placeholder="deces" required />
